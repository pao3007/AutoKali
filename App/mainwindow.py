...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_start.setGeometry(QtCore.QRect(40, 210, 141, 61))
        self.btn_start.setObjectName("btn_start")
        self.btn_start.setEnabled(False)
        self.progressBar = QtWidgets.QProgressBar(self.centralwidget)
        self.progressBar.setGeometry(QtCore.QRect(200, 250, 281, 23))
        self.progressBar.setProperty("value", 24)
        self.progressBar.setObjectName("progressBar")
        self.label_progress = QtWidgets.QLabel(self.centralwidget)
        self.label_progress.setGeometry(QtCore.QRect(200, 210, 281, 31))
        font = QtGui.QFont()
        ...
        self.output_browser.setGeometry(QtCore.QRect(40, 280, 441, 141))
