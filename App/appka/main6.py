...
class autokali(PyQt5.QtCore.QObject):
    ...
    def on_btn_start_clicked(self):  # start merania
        ...
        self.thread_prog_bar = PyQt5.QtCore.QThread()
        self.thread_ref_sens = PyQt5.QtCore.QThread()

        self.worker_start_prog_bar = start_timer_worker((self.measure_time+4))
        self.worker_start_ref_sens_data_collection = start_ref_sens_data_collection_worker()

        self.worker_start_prog_bar.moveToThread(self.thread_prog_bar)
        self.worker_start_ref_sens_data_collection.moveToThread(self.thread_ref_sens)

        self.thread_prog_bar.started.connect(self.worker_start_prog_bar.run)
        self.worker_start_prog_bar.progress_signal.connect(self.update_progressBar)
        # self.worker_start_prog_bar.finished.connect(self.thread_prog_bar.quit)
        # self.thread_prog_bar.finished.connect(self.thread_prog_bar.deleteLater)

        self.thread_ref_sens.started.connect(self.worker_start_ref_sens_data_collection.run)
        # self.worker_start_ref_sens_data_collection.finished.connect(self.thread_ref_sens.quit)
        # self.thread_ref_sens.finished.connect(self.thread_ref_sens.deleteLater)
